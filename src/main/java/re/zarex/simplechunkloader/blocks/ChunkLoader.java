...
public class ChunkLoader extends BlockWithEntity {
    ...
    public static void Register() {
        ...
        BLOCK = new ChunkLoader(FabricBlockSettings.create().pistonBehavior(PistonBehavior.BLOCK).strength(1.0f).requiresTool().nonOpaque());
        Identifier ID = new Identifier("simplechunkloader", "chunkloader");
        Registry.register(Registries.BLOCK, ID, BLOCK);
        Registry.register(Registries.ITEM, ID, new ChunkLoaderItem(BLOCK, new FabricItemSettings()));
